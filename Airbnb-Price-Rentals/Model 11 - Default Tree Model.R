...
tree11 <- rpart(price ~ accommodates + room_type + bathrooms + 
...
pred_price11_test <- predict(tree11, newdata = test_data_cleaning)
RMSE(pred_price11_test, test_data_cleaning$price)
...
pred_price11_scoring <- predict(tree11, newdata = scoring_data_cleaning)
...
submissionDataFrame = data.frame(id = scoring_data_cleaning$id, price = pred_price11_scoring)
